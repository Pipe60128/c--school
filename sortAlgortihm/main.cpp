...
int main() {
    ...
    Busqueda :: swapSort(array4,size4);
    Busqueda :: printArray(array4,size4);
    cout<<"------------------"<<endl;
    ...
    int array7[]={5,3,8,4,2};
    int size7= sizeof(array7)/sizeof(array7[0]);
    cout<<"Array before sort"<<endl;
    Busqueda :: printArray(array7,size7);
    cout<<"Array after sort"<<endl;
    Busqueda :: selectionSort(array7,size7);
    Busqueda :: printArray(array7,size7);
    cout<<"------------------"<<endl;
    ...
    int array8[]={5,3,8,4,2};
    int size8= sizeof(array8)/sizeof(array8[0]);
    cout<<"Array before sort"<<endl;
    Busqueda :: printArray(array8,size8);
    cout<<"Array after sort"<<endl;
    Busqueda :: quickSort(array8,size8);
    Busqueda :: printArray(array8,size8);
    cout<<"------------------"<<endl;
        ...
        if (menu == 1){ //SEARCH A NUMBER 
            ...
            if (sortMenu == 1){
                ...
                if (sortType == 1){
                    ...
                    cout<<"You selected insertion sort"<<endl;
                    Busqueda :: insertcionSort(array2,n);
                } else if (sortType == 3){
                    cout<<"You selected merge sort"<<endl;
                    ...
                    cout<<"You selected insercion sort"<<endl;
                    Busqueda :: swapSort(array2,n); 
                } else if(sortType == 6){
                    cout<<"You selected selection sort"<<endl;
                    Busqueda :: selectionSort(array2,n);
                } else {
                    cout<<"Invalid option"<<endl;
                }
                cout<<"Array after sort"<<endl;
                duplicateArray(array2,n);
                Busqueda :: printArray(array2,n);
            }
